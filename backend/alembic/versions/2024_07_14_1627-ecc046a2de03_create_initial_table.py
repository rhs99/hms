...
Revision ID: ecc046a2de03
Revises: 
Create Date: 2024-07-14 16:27:20.162505
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "day",
            sa.Enum(
                "SAT", "SUN", "MON", "TUE", "WED", "THU", "FRI", name="weekdayenum"
            ),
            nullable=False,
        ),
        sa.ForeignKeyConstraint(
        ...
        sa.PrimaryKeyConstraint("slot_id", "wh_id", "day"),
    )
